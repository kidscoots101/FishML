...
### NOTE
In our program there's a specific segment which requires customisation on your end. As the path to our datasets will be different from yours, it will require some changing.<br />
...
### Step 1:
Open our program (ENTIRE coursework folder) in your desired code editor.
